 ...
 */
export default class MoneyDashboard {
      ...
      cognitoUser.authenticateUser(authenticationDetails, {
        ...
        onSuccess: function (result) {
          AWS.config.credentials = new AWS.CognitoIdentityCredentials({
            IdentityPoolId: AWS_COGNITO_CONFIG.IDENTITY_POOL_ID, // your identity pool id here
            Logins: {
  ...
  async listAccounts(): Promise<Account[]> {
    ...
    const _accounts: Object[] = response.data
  ...
  async getTransactions(accountIds:String[], startDate: string, endDate: string): Promise<Transaction[]> {
    ...
    const _transactions: Object[] = response.data
  ...
  async getBudgets(fromDate: string, toDate: string): Promise<Budget[]> {
    ...
    const _budgets: Object[] = response.data
  ...
  async listCategories(): Promise<Category[]> {
    ...
    const _categories: Object = response.data
